...
<div class="policy-container">
	<div data-aos="fade-left" class="policy-section">
		<h3>1173236 Ontario Inc. Operating as The Big Leaf</h3>
		<p>Effective date: July 1, 2022</p>
		<p>
			1173236 Ontario Inc., o/a The Big Leaf (“us”, “we”, or “our”) operates the <a
				target="_blank"
				href="https://thebigleaf.com/">Big Leaf</a
		...
		<p>
			...
			Terms and Conditions, accessible from <a href="/privacy">the privacy page</a>.
		</p>
	</div>
	<div data-aos="fade-right" class="policy-section">
		<h3>Definitions</h3>
		<h2>Service</h2>
		<p>Service is the <a href="/">Handlers</a> website operated by 1173236 Ontario Inc.</p>
		<h2>Personal Data</h2>
		<p>
	...
	<div data-aos="fade-left" class="policy-section">
		...
		<p>
			We only use your Personal Data to <u
				>reach out to you in the event that you have asked us to do so</u
			>. You are automatically opted out of receiving any and all communications from us.
		</p>
		<h2>Usage Data</h2>
		<p>
	...
	<div data-aos="fade-right" class="policy-section">
		...
		<p>
			1173236 Ontario Inc. We will only ever reach out to you via email or telephone if you have
			indicated that you wish us to do so, via our Contact Us page or via direct email to our team.
		</p>
	</div>
	<div data-aos="fade-left" class="policy-section">
		<h3>
		...
		<h1>
			If you are from the European Economic Area (EEA), 1173236 Ontario Inc.1173236 Ontario Inc.’s
			legal basis for collecting and using the personal information described in this Privacy Policy
	...
	<div data-aos="fade-right" class="policy-section">
		...
		<p>
			1173236 Ontario Inc. will retain your Personal Data only for as long as is necessary for the
		...
		<p>
			1173236 Ontario Inc. will also retain Usage Data for internal analysis purposes. Usage Data is
	...
	<div data-aos="fade-left" class="policy-section">
		...
		<p>
			1173236 Ontario Inc. will take all the steps reasonably necessary to ensure that your data is
	...
	<div data-aos="fade-right" class="policy-section">
		...
		<h1>
			If 1173236 Ontario Inc. is involved in a merger, acquisition or asset sale, your Personal Data
			will not be transferred. We will destroy your Personal Data (email) via deletion prior to any
	...
	<div data-aos="fade-left" class="policy-section">
		...
		<p>
			1173236 Ontario Inc. may disclose your Personal Data in the good faith belief that such action
			is necessary to:
		</p>
		<ul>
	...
	<div data-aos="fade-right" class="policy-section">
		...
		<p>
			We do not support Do Not Track (“DNT”) natively in our website. Do Not Track is a preference
	...
	<div data-aos="fade-left" class="policy-section">
		...
		<p>
			...
			rights. 1173236 Ontario Inc. aims to take reasonable steps to allow you to correct, amend,
		...
		<p>
			...
			settings section. If you are unable to perform these actions yourself, please contact us to
			assist you.
		</p>
		<p>
		...
		<p>
			...
			where 1173236 Ontario Inc. relied on your consent to process your personal information.
		</p>
		<p>
	...
	<div data-aos="fade-left" class="policy-section">
		...
		<p>By visiting this page on our website: <a href="/contact">Click here</a></p>
	</div>
</div>
